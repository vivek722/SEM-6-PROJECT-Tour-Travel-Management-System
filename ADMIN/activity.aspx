...
&nbsp;<asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False" DataKeyNames="Id" DataSourceID="SqlDataSource1" BackColor="White" BorderColor="#999999" BorderStyle="None" BorderWidth="1px" CellPadding="3" GridLines="Vertical">
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConflictDetection="CompareAllValues" ConnectionString="<%$ ConnectionStrings:connectionstring1 %>" DeleteCommand="DELETE FROM [activity] WHERE [Id] = @original_Id AND [activity_name] = @original_activity_name AND [activity_price] = @original_activity_price AND [activity_requirment] = @original_activity_requirment AND [actvity_place] = @original_actvity_place AND [activity_description] = @original_activity_description AND [photo] = @original_photo AND [status] = @original_status" InsertCommand="INSERT INTO [activity] ([activity_name], [activity_price], [activity_requirment], [actvity_place], [activity_description], [photo], [status]) VALUES (@activity_name, @activity_price, @activity_requirment, @actvity_place, @activity_description, @photo, @status)" OldValuesParameterFormatString="original_{0}" ProviderName="<%$ ConnectionStrings:connectionstring1.ProviderName %>" SelectCommand="SELECT * FROM [activity]" UpdateCommand="UPDATE [activity] SET [activity_name] = @activity_name, [activity_price] = @activity_price, [activity_requirment] = @activity_requirment, [actvity_place] = @actvity_place, [activity_description] = @activity_description, [photo] = @photo, [status] = @status WHERE [Id] = @original_Id AND [activity_name] = @original_activity_name AND [activity_price] = @original_activity_price AND [activity_requirment] = @original_activity_requirment AND [actvity_place] = @original_actvity_place AND [activity_description] = @original_activity_description AND [photo] = @original_photo AND [status] = @original_status">
                    <DeleteParameters>
                        <asp:Parameter Name="original_Id" Type="Int32" />
                        <asp:Parameter Name="original_activity_name" Type="String" />
                        <asp:Parameter Name="original_activity_price" Type="String" />
                        <asp:Parameter Name="original_activity_requirment" Type="String" />
                        <asp:Parameter Name="original_actvity_place" Type="String" />
                        <asp:Parameter Name="original_activity_description" Type="String" />
                        <asp:Parameter Name="original_photo" Type="String" />
                        <asp:Parameter Name="original_status" Type="String" />
                    </DeleteParameters>
                    <InsertParameters>
                        <asp:Parameter Name="activity_name" Type="String" />
                        <asp:Parameter Name="activity_price" Type="String" />
                        <asp:Parameter Name="activity_requirment" Type="String" />
                        <asp:Parameter Name="actvity_place" Type="String" />
                        <asp:Parameter Name="activity_description" Type="String" />
