            ...
            <form id="form1" runat="server">
              ...
              <asp:DropDownList ID="DropDownList1" runat="server" style="width: 50%; padding: 15px; margin: 5px 0 22px 0; display: inline-block; border: none; background: #f1f1f1;">
               ...
               <%-- <button type="submit" class="registerbtn1"><b>Re-Set</b></button>--%>
                  ...
                  <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConflictDetection="CompareAllValues" ConnectionString="<%$ ConnectionStrings:connectionstring1 %>" DeleteCommand="DELETE FROM [hotel] WHERE [Id] = @original_Id AND [hotel_contact_no] = @original_hotel_contact_no AND [hotel_name] = @original_hotel_name AND [hotel_description] = @original_hotel_description AND [price_per_night] = @original_price_per_night AND [photo] = @original_photo AND [status] = @original_status AND [city] = @original_city" InsertCommand="INSERT INTO [hotel] ([hotel_contact_no], [hotel_name], [hotel_description], [price_per_night], [photo], [status], [city]) VALUES (@hotel_contact_no, @hotel_name, @hotel_description, @price_per_night, @photo, @status, @city)" OldValuesParameterFormatString="original_{0}" ProviderName="<%$ ConnectionStrings:connectionstring1.ProviderName %>" SelectCommand="SELECT * FROM [hotel]" UpdateCommand="UPDATE [hotel] SET [hotel_contact_no] = @hotel_contact_no, [hotel_name] = @hotel_name, [hotel_description] = @hotel_description, [price_per_night] = @price_per_night, [photo] = @photo, [status] = @status, [city] = @city WHERE [Id] = @original_Id AND [hotel_contact_no] = @original_hotel_contact_no AND [hotel_name] = @original_hotel_name AND [hotel_description] = @original_hotel_description AND [price_per_night] = @original_price_per_night AND [photo] = @original_photo AND [status] = @original_status AND [city] = @original_city">
                      <DeleteParameters>
                          <asp:Parameter Name="original_Id" Type="Int32" />
                          <asp:Parameter Name="original_hotel_contact_no" Type="String" />
                          <asp:Parameter Name="original_hotel_name" Type="String" />
                          <asp:Parameter Name="original_hotel_description" Type="String" />
                          <asp:Parameter Name="original_price_per_night" Type="String" />
                          <asp:Parameter Name="original_photo" Type="String" />
                          <asp:Parameter Name="original_status" Type="String" />
                          <asp:Parameter Name="original_city" Type="String" />
                      </DeleteParameters>
                      <InsertParameters>
                          <asp:Parameter Name="hotel_contact_no" Type="String" />
